...
public:
  ...
  enum {
    ...
    RuleUnitExpression = 12, RuleTopLevelDeclaration = 13, RuleUnambiguousTopLevelDeclaration = 14, 
    RuleFunctionDeclaration = 15, RuleUnambiguousFunctionDeclaration = 16, 
    RuleStringIdentifier = 17, RuleUseDeclaration = 18, RuleIncludeDeclaration = 19, 
    RuleProgramDeclaration = 20, RuleUnambiguousProgramDeclaration = 21, 
    RuleUnambiguousStatement = 22, RuleStatement = 23, RuleStatementLabel = 24, 
    RuleIfStatement = 25, RuleUnambiguousIfStatement = 26, RuleGotoStatement = 27, 
    RuleReturnStatement = 28, RuleUnambiguousReturnStatement = 29, RuleConstStatement = 30, 
    RuleUnambiguousConstStatement = 31, RuleVarStatement = 32, RuleUnambiguousVarStatement = 33, 
    RuleDoStatement = 34, RuleUnambiguousDoStatement = 35, RuleWhileStatement = 36, 
    RuleUnambiguousWhileStatement = 37, RuleExitStatement = 38, RuleDeclareStatement = 39, 
    RuleBreakStatement = 40, RuleContinueStatement = 41, RuleForStatement = 42, 
    RuleUnambiguousForStatement = 43, RuleForeachStatement = 44, RuleUnambiguousForeachStatement = 45, 
    RuleRepeatStatement = 46, RuleUnambiguousRepeatStatement = 47, RuleCaseStatement = 48, 
    RuleUnambiguousCaseStatement = 49, RuleEnumStatement = 50, RuleUnambiguousEnumStatement = 51, 
    RuleBlock = 52, RuleUnambiguousBlock = 53, RuleVariableDeclarationInitializer = 54, 
    RuleUnambiguousVariableDeclarationInitializer = 55, RuleEnumList = 56, 
    RuleUnambiguousEnumList = 57, RuleEnumListEntry = 58, RuleUnambiguousEnumListEntry = 59, 
    RuleSwitchBlockStatementGroup = 60, RuleUnambiguousSwitchBlockStatementGroup = 61, 
    RuleSwitchLabel = 62, RuleForGroup = 63, RuleUnambiguousForGroup = 64, 
    RuleBasicForStatement = 65, RuleUnambiguousBasicForStatement = 66, RuleCstyleForStatement = 67, 
    RuleUnambiguousCstyleForStatement = 68, RuleIdentifierList = 69, RuleVariableDeclarationList = 70, 
    RuleUnambiguousVariableDeclarationList = 71, RuleVariableDeclaration = 72, 
    RuleUnambiguousVariableDeclaration = 73, RuleProgramParameters = 74, 
    RuleProgramParameterList = 75, RuleProgramParameter = 76, RuleUnambiguousProgramParameters = 77, 
    RuleUnambiguousProgramParameterList = 78, RuleUnambiguousProgramParameter = 79, 
    RuleFunctionParameters = 80, RuleFunctionParameterList = 81, RuleFunctionParameter = 82, 
    RuleUnambiguousFunctionParameters = 83, RuleUnambiguousFunctionParameterList = 84, 
    RuleUnambiguousFunctionParameter = 85, RuleScopedMethodCall = 86, RuleUnambiguousExpression = 87, 
    RuleAssignmentOperator = 88, RuleMembership = 89, RuleMembershipOperator = 90, 
    RuleDisjunction = 91, RuleDisjunctionOperator = 92, RuleConjunction = 93, 
    RuleConjunctionOperator = 94, RuleEquality = 95, RuleEqualityOperator = 96, 
    RuleBitwiseDisjunction = 97, RuleBitwiseXor = 98, RuleBitwiseConjunction = 99, 
    RuleBitshiftRight = 100, RuleBitshiftLeft = 101, RuleComparison = 102, 
    RuleComparisonOperator = 103, RuleInfixOperation = 104, RuleInfixOperator = 105, 
    RuleElvisExpression = 106, RuleAdditiveExpression = 107, RuleAdditiveOperator = 108, 
    RuleMultiplicativeExpression = 109, RuleMultiplicativeOperator = 110, 
    RulePrefixUnaryInversionExpression = 111, RulePrefixUnaryInversionOperator = 112, 
    RulePrefixUnaryArithmeticExpression = 113, RulePrefixUnaryArithmeticOperator = 114, 
    RulePostfixUnaryExpression = 115, RulePostfixUnaryOperator = 116, RuleIndexingSuffix = 117, 
    RuleNavigationSuffix = 118, RuleMembershipSuffix = 119, RuleMemberCallSuffix = 120, 
    RuleMemberAccessOperator = 121, RuleCallSuffix = 122, RuleAtomicExpression = 123, 
    RuleFunctionReference = 124, RuleUnambiguousExplicitArrayInitializer = 125, 
    RuleUnambiguousExplicitStructInitializer = 126, RuleUnambiguousExplicitDictInitializer = 127, 
    RuleUnambiguousExplicitErrorInitializer = 128, RuleUnambiguousBareArrayInitializer = 129, 
    RuleParenthesizedExpression = 130, RuleExpression = 131, RulePrimary = 132, 
    RuleParExpression = 133, RuleExpressionList = 134, RuleUnambiguousExpressionList = 135, 
    RuleMethodCallArgument = 136, RuleMethodCallArgumentList = 137, RuleMethodCall = 138, 
    RuleValueArgumentList = 139, RuleValueArguments = 140, RuleUnambiguousFunctionCallArgument = 141, 
    RuleUnambiguousFunctionCall = 142, RuleUnambiguousScopedFunctionCall = 143, 
    RuleUnambiguousFunctionCallArgumentList = 144, RuleMemberCall = 145, 
    RuleStructInitializerExpression = 146, RuleStructInitializerExpressionList = 147, 
    RuleStructInitializer = 148, RuleUnambiguousStructInitializerExpression = 149, 
    RuleUnambiguousStructInitializerExpressionList = 150, RuleUnambiguousStructInitializer = 151, 
    RuleDictInitializerExpression = 152, RuleUnambiguousDictInitializerExpression = 153, 
    RuleDictInitializerExpressionList = 154, RuleUnambiguousDictInitializerExpressionList = 155, 
    RuleDictInitializer = 156, RuleUnambiguousDictInitializer = 157, RuleArrayInitializer = 158, 
    RuleUnambiguousArrayInitializer = 159, RuleLiteral = 160, RuleIntegerLiteral = 161, 
    RuleFloatLiteral = 162
  };
