...
void map_test()
{
  ...
  INFO_PRINT2( "{} {}", cell.landtile, cell.z );
}
...
void dynprops_test()
{
  ...
  {
    INFO_PRINT2( "initial ar {} {}", h.armod(), h.has_armod() );
  ...
  {
    INFO_PRINT2( "ar {} {}", h.armod(), h.has_armod() );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
  ...
  if ( h.armod() || h.has_armod() )
  {
    INFO_PRINT2( "removed ar {} {}", h.armod(), h.has_armod() );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
  ...
  {
    INFO_PRINT2( "initial name {} {}", h.itemname(), h.has_itemname() );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
  ...
  {
    INFO_PRINT2( "name {} {}", h.itemname(), h.has_itemname() );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
  ...
  if ( !h.itemname().empty() || h.has_itemname() )
  {
    INFO_PRINT2( "removed name {} {}", h.itemname(), h.has_itemname() );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
                          ...
                          const std::string& exp_pv )
{
  ...
  {
    INFO_PRINT2( "splitnamevalue( \"{}\" ) fails!", istr );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
...
void test_dqs( const std::string& in, const std::string& out )
{
  ...
  if ( tmp != out )
  {
    INFO_PRINT2( "decodequotedstring( {} ) fails!", in );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
  ...
  if ( tmp != in )
  {
    INFO_PRINT2( "encodequotedstring( {} ) fails!", out );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
...
void test_cp1252ToUtf8( const std::string& in, const std::string& expected )
{
  ...
  {
    INFO_PRINT2( "CP-1252 to UTF-8 conversion fails!" );
    UnitTest::inc_failures();
  }
  else
  {
...
void test_utf8ToCp1252( const std::string& in, const std::string& expected )
{
  ...
  if ( converted != expected )
  {
    INFO_PRINT2( "UTF-8 to CP-1252 conversion fails!" );
    UnitTest::inc_failures();
  }
  else
  {
...
void test_curlfeatures()
{
  ...
  {
    INFO_PRINT_N2( "{} ", data->protocols[i] );
  ...
  if ( !https || !http )
  {
    INFO_PRINT2( "http(s) is not supported" );
    UnitTest::inc_failures();
  }
  else
    UnitTest::inc_successes();
