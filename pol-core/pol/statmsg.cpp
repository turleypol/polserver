...
void send_full_statmsg( Network::Client* client, Mobile::Character* chr )
{
  ...
  else if ( client->supports( Plib::ExpansionVersion::ML ) &&
  ...
  if ( client->supports( Plib::ExpansionVersion::AOS ) && client->aosresist )
  {
  ...
  // moreinfo 5
  if ( client->supports( Plib::ExpansionVersion::ML ) &&
       ( client->ClientType & Network::CLIENTTYPE_5000 ) )
  {
