...
bool UBoat::navigable( const MultiDef& md, const Core::Pos4d& desired_pos )
{
  ...
  {
#ifdef DEBUG_BOATS
    INFO_PRINT2( "Location {} impassable, location is off the map", desired_pos );
#endif
    return false;
  }
  ...
  for ( const auto& ele : md.hull )
  {
    ...
    {
#ifdef DEBUG_BOATS
      INFO_PRINT2( "Location {} {} already has a ship hull present", desired_pos.realm()->name(),
                   hullpos );
#endif
      return false;
    }
