...
ExternalProject_Add(kaitai_Ext
  SOURCE_DIR  ${KAITAI_SOURCE_DIR}
    PREFIX kaitai
    LIST_SEPARATOR |
    CMAKE_ARGS -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${KAITAI_INSTALL_DIR} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DSTRING_ENCODING_TYPE=NONE -DBUILD_SHARED_LIBS=Off -DBUILD_TESTS=Off
