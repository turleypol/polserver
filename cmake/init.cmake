...
#  endif()
  ...
  elseif (APPLE)
    ...
    include_directories(BEFORE ${OPENSSL_INCLUDEDIR})
    link_directories(${OPENSSL_LIBDIR})
    message( "OpenSSL  found1 ${OPENSSL_INCLUDEDIR}")
    message("v ${OPENSSL_VERSION}")
    message("i ${OPENSSL_INCLUDEDIR}")
    message("l ${OPENSSL_LIBDIR}")
    message("p ${OPENSSL_PREFIX}")
    set(HAVE_OPENSSL ${OPENSSL_FOUND})
    pkg_search_module(MYSQL mysql-client)
    message( "mysql  found ${MYSQL_INCLUDEDIR}")
